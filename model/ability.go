...
func GetGroupEnabledModels(group string) []string {
	...
	DB.Table("abilities").Where(commonGroupCol+" = ? and enabled = ?", group, true).Distinct("model").Order("model").Pluck("model", &models)
	return models
}
...
func GetEnabledModels() []string {
	var models []string
	// Find distinct models
	DB.Table("abilities").Where("enabled = ?", true).Distinct("model").Order("model").Pluck("model", &models)
	return models
}
